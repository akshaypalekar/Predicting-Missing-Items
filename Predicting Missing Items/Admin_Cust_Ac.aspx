<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Cust_Ac.aspx.cs" Inherits="Admin_Cust_Ac" %>
...
<form id="form1" runat="server">
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Online_ShopConnectionString %>"
            SelectCommand="SELECT [U_No], [U_Name], [U_Address], [U_Contact], [U_Email], [A_Status] FROM [Cust_Data]">
        </asp:SqlDataSource>
        <br />
        <br />
        <table>
