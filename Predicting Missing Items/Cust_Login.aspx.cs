...
public partial class Cust_Login : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Count(*) from Cust_Login where Username='" + TextBox1.Text + "' and Password='" + TextBox2.Text + "'";
        ...
        else
        {
            cn.Open();
            cmd.Connection = cn;
            cmd.CommandText = "select Count(*) from Cust_Data where U_No='" + TextBox1.Text + "' and A_Status='On'";
            rs = cmd.ExecuteReader();
            while (rs.Read())
            {
